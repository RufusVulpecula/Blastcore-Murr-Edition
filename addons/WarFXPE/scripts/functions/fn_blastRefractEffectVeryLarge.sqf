/*
	...
	Description:
	Spawns a very large refract wave.

	Parameters:
		_this: ARRAY - Position format AGL.

	Usage: "WarFXPE\scripts\blastrefractEffectVeryLarge.sqf";
